		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "opdracht2",
									"targetURL": "#opdracht2opdracht2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"opdracht2opdracht2-display": {
								"semanticObject": "opdracht2opdracht2",
								"action": "display",
								"description": "opdracht2",
								"title": "opdracht2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=opdracht2.opdracht2",
									"url": sap.ui.require.toUrl("opdracht2/opdracht2")
								}
							}
						}
					}
